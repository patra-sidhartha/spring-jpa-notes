...
- GenerationType.IDENTITY: This strategy relies on an auto-incremented column in the database.
...
- GenerationType.TABLE: This strategy uses a separate database table to simulate a sequence.
